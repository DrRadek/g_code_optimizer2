...
VkResult nvshaders::VolumeSumCompute::init(nvvk::ResourceAllocator* alloc, std::span<const uint32_t> spirv)
{
  ...
  //alloc->createBuffer(m_obbBuffer_final, sizeof(shaderio::OBB), VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT,
...
{
  nvvk::cmdBufferMemoryBarrier(cmd, {srcBuffer->buffer, VK_PIPELINE_STAGE_2_TRANSFER_BIT, VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT});
